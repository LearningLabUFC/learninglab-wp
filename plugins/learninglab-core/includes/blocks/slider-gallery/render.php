 ...
 *
 * Renderiza o Swiper.js com suporte a imageSize, linkTo, navegação, bullets e legendas.
 *
...
$images           = isset( $attributes['images'] ) && is_array( $attributes['attributes'] ?? $attributes['images'] ) ? $attributes['images'] : [];
